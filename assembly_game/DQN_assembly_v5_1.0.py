...
if __name__ == "__main__":
    ...
    log_path = os.path.join(args.logdir, "assemblygame_v4", "dqn")
    ...
    def save_best_fn(policy):
        model1_save_path = os.path.join("log", "assembly", "dqn", "policy.pth")
        model2_save_path = os.path.join("log", "assembly", "dqn", "policy.pth")
