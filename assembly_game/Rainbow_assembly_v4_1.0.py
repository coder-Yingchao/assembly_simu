...
from tianshou.policy import DQNPolicy, MultiAgentPolicyManager , RainbowPolicy, C51Policy
...
if __name__ == "__main__":
    ...
    policy1: C51Policy = RainbowPolicy(
        model=net1,
        optim=optim1,
        discount_factor=0.9,
    ...
    args: argparse.Namespace = get_args()
    log_path = os.path.join(args.logdir, "assemblygame_v4", "Rainbow")
