...
max_steps = 500  # Define a maximum number of steps
...
class ComputerAssemblyEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.MultiDiscrete([10, 10])  # Each hand can perform 9 actions
        ...
        n_components = 8
        # obs_space_low = [0, 0, 1] * n_components
        # obs_space_high = [self.game.screen_width, self.game.screen_height, 4] * n_components
    ...
    def step(self, action):
        ...
        reward, terminated = self.game.move_hands_simultaneously(action[0] + 1, action[1] + 2)
