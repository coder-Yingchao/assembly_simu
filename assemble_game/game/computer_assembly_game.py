...
class ComputerAssemblyGame:
    ...
    def move_hands_simultaneously(self, action_hand1, action_hand2):
        ...
        print(f"Hand2 moved {steps_hand2} steps" + (
            " and interacted with the case." if action_hand2 == 9 else f" and picked up component {action_hand2}.") if component_id2 is not None else "Hand2 did not pick up a component or interact with the case.")
