...
class ComputerAssemblyGame:
    def __init__(self):
        ...
        self.background_image = pygame.transform.scale(pygame.image.load('/home/you/Project/sb3_contrib/pythonProject/assembly_game/game/image/background.png'), (self.screen_width, self.screen_height))
        self.case_image = pygame.transform.scale(pygame.image.load('/home/you/Project/sb3_contrib/pythonProject/assembly_game/game/image/case.png'),(self.case_width,self.case_height))
        ...
        self.assist_reward = 200
        self.completion_reward = 1000
        ...
        self.log_file_path = '/home/you/Project/sb3_contrib/pythonProject/assembly_game/game/data/state_log.txt'
        self.write_log_header()
        self.action_log_file_path = '/home/you/Project/sb3_contrib/pythonProject/assembly_game/game/data/action_log.txt'
    ...
    def hand1_operate (self):
        # if self.target_x1 is None:
        #     print(f'action_hand1: {self.action_hand1}, {self.hand_x}, {self.target_x1}')
    ...
    def hand2_operate(self):
        # if self.target_x2 is None:
        #     print(f'action_hand2: {self.action_hand2}, {self.second_hand_x}, {self.target_x2}')
    ...
    def initialize_components(self):
        ...
        image_paths_b = ['game/image/motherboard.png', 'game/image/cpu.png', 'game/image/cooler.png', 'game/image/gpu.png',
                       'game/image/memory_card.png', 'game/image/power_supply.png', 'game/image/hard_disk.png',
                       'game/image/cover.png']
        image_paths = []

        for image_path in image_paths_b:
            image_path= '/home/you/Project/sb3_contrib/pythonProject/assembly_game/'+ image_path
    ...
    def initialize_hands(self):
        ...
        self.hand1_image = pygame.transform.scale(pygame.image.load("/home/you/Project/sb3_contrib/pythonProject/assembly_game/game/image/hand.png"), (30, 30))
        self.hand2_image = pygame.transform.scale(pygame.image.load("/home/you/Project/sb3_contrib/pythonProject/assembly_game/game/image/robot.png"), (30, 30))
