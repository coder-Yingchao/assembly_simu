...
if __name__ == "__main__":
    ...
    actor_critic1 = ActorCritic(policy_net1,imitation_net1)
    optim1 = torch.optim.Adam(actor_critic1.parameters(), lr=args.lr)
    policy1: DiscreteBCQPolicy = DiscreteBCQPolicy(
        model=policy_net1,
        imitator=imitation_net1,
        optim=optim1,
